...
# along with Mantis.  If not, see <http://www.gnu.org/licenses/>.
	...
	//alterando na mão o ref para evitar que vá direto para a página bug_report_advanced_page.php, ao invés disso vai para a abertura integrada PROSEGUR 16/09/2011
	if (strstr($f_ref, "bug_report_advanced_page.php")) {
		$f_ref = "task_report_integrated_page.php";
	}
