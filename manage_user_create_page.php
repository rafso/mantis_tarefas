...
<tr <?php echo helper_alternate_class() ?>>
	...
	<td width="75%">
		<input type="text" name="username" id="username" size="32" maxlength="32" /> <img src='images/BtnLocalizar.gif' onclick="ldap('username', 'realname', 'email1')" border=0></a> Pesquisar LDAP
	</td>
</tr>
<tr <?php echo helper_alternate_class() ?>>
	<td class="category">
	...
	<td>
		<input type="text" name="realname" id="realname" size="32" maxlength="32" />
	</td>
</tr>
<tr <?php echo helper_alternate_class() ?>>
	<td class="category">
	...
	<td>
		<?php print_email_input( 'email', '' ) ?> <label id="email1"></label>
	</td>
</tr>
<?php
