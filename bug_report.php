...
//	$t_bug_data->profile_id			= gpc_get_int( 'profile_id', 0 );
	...
	//recebe os parametros da tarefa PROSEGUR 27/02/2011
	$t_bug_data->type_task			= gpc_get_int( 'type', 0 );
	$t_bug_data->date_start			= gpc_get_string( 'data_inicio', '' );
	$t_bug_data->date_end			= gpc_get_string( 'data_fim', '' );
...
//	$t_bug_data->reproducibility		= config_get( 'default_bug_reproducibility' ); //gpc_get_int( 'reproducibility', config_get( 'default_bug_reproducibility' ) );
//	$t_bug_data->severity				= config_get( 'default_bug_severity' ); //gpc_get_int( 'severity', config_get( 'default_bug_severity' ) );
