...
<br />
<?php print_summary_menu( 'task_parcial_report.php' ) ?>
...
<tr valign="top">
	<td width="50%">
		...
		<tr>
			<td class="form-title" colspan="1">
				<?php echo lang_get( 'by_type' ) ?>
			</td>
			<?php echo $t_orcttab ?>
		</tr>
		<?php summary_print_by_enum( config_get( 'type_enum_string' ), 'type_task' ) ?>
		</table>

		<br />

		<?php /* comentado por não querer o resumo por categoria PROSEGUR 02/06/2011
		# CATEGORY # ?>
		<table class="width100" cellspacing="1">
		<tr>
			<td class="form-title" colspan="1">
	...
	<td width="50%">
		...
		<?php /* removendo resumo de eficiência do relator
