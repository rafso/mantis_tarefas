...
# along with Mantis.  If not, see <http://www.gnu.org/licenses/>.
	...
	html_page_top1();
	html_page_top2a_login();  //alterado para efetuar uma chamada diferenciada na página de login, sem o título do sistema PROSEGUR 10-06-2010
...
<table class="td_login" cellspacing="1">
<tr>
	<td class="category_login_title" colspan="2">
		<?php
...
<tr>
	<td class="category_login" width="28%">
		<?php echo lang_get( 'username' ) ?>
	</td>
	<td width="75%">
		<input type="text" name="username" size="32" maxlength="32" class="login_1"/>
	</td>
</tr>
<tr>
	<td class="category_login">
		<?php echo lang_get( 'password' ) ?>
	</td>
	<td>
		<input type="password" name="password" size="32" maxlength="32"  class="login_2"/>
	</td>
</tr>
<tr>
	<td class="category_login">
...
<tr>
	<td class="center" colspan="2">
		<input type="submit" class="button_login" value="<?php echo lang_get( 'login_button' ) ?>" />
	</td>
</tr>
</table>
</form>
