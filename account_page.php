...
?>
<?php
	//feito para visualizar se existe no temp um arquivo avatar para o usuário, se houver, apaga. PROSEGUR 06/06/2011
	echo '<body class="bodyAvatar" onunload="onunloadDellAvatar(\''. auth_get_current_user_id() .'\')">';
...
<?php } ?> <!-- End LDAP Email conditional -->
	...
	<tr class="row-2" valign="top">
		...
		<td>
			<?php //exibe o avatar e permite ao usuário alterar PROSEGUR 03/06/2011
			 ?>
			<iframe id="ifrFileUpload" class="IfrAvatar" scrolling="no" frameborder="0" hidefocus="true" src="task_util.php?file=1">
            </iframe>
		</td>
	</tr>
