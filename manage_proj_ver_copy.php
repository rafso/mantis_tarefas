...
# along with Mantis.  If not, see <http://www.gnu.org/licenses/>.
	...
	foreach ( $t_rows as $t_row ) {
		...
		version_add( $t_dst_project_id, $t_row['version'], $t_row['released'], $t_row['description'] ); //alterado o ultimo parâmetro, estava sendo passado $t_row['date_order'], porém em formato incorreto e copiando a do outro projeto, fica melhor colocar a data atual, para isso passamos nenhum parâmetro que ele pega a atual PROSEGUR 07/07/2011
		}
	}
