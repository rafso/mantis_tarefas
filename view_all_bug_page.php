...
<?php
	...
	$rows = filter_get_bug_rows( $f_page_number, $t_per_page, $t_page_count, $t_bug_count, null, null, null, true, $p_id_array ); //adicionado o parametro $p_id_array, para retornar o total de bugs, retorna array de ids.. PROSEGUR 02/06/2011
	if ( $rows === false ) {
