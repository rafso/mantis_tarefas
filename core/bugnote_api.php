...
# along with Mantis.  If not, see <http://www.gnu.org/licenses/>.
	...
	# return the ID of the new bugnote
		#adicionado o parâmetro $p_send_email=true para forçar o envio de e-mail ao adicionar uma nota, não estava sendo enviado pois esse parâmetro não está sendo informado na chamada da função
