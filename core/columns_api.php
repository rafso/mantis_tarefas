...
#inserido para a coluna de data de INÍCIO da tarefa da tarefa PROSEGUR 06/03/2011
...
#inserido para a coluna de data de conclusão da tarefa da tarefa PROSEGUR 06/03/2011
	...
	//coluna de bugs críticos do relatório parcial	
	...
	//coluna de observação críticos do relatório parcial	
	...
	//if (access_has_global_level(config_get('set_relationship_filter_bugs'))) {   //verificar se possui permissão de visualizar a coluna
		echo '<td class="right1">';
		echo '<label id="coverageValue'. $p_row["id"] .'">'. $p_row["coverage"] . '</label>%';
		//verifica se já foi enviado com 100% para exibir o simbolo indicando
	...
	# --------------------
	# $p_columns_target: see COLUMNS_TARGET_* in constant_inc.php, inserido o parâmetro $partial_report que quando recebe 1, força que seja escrito o nome do projeto ao invés da categoria PROSEGUR 08/06/2011
	function print_column_category( $p_row, $p_columns_target = COLUMNS_TARGET_VIEW_PAGE, $partial_report = null ) {
		...
		if ($partial_report == 1){ //apresenta de forma diferente a coluna na tela de relatório parcial PROSEGUR 12/07/2011
			echo '<small>';
	...
	# coluna do relatório parcial para ser digitado o número de bugs críticos PROSEGUR 12/07/2011
	...
	# coluna do relatório parcial para ser digitado a observação PROSEGUR 12/07/2011
	...
	# --------------------
	# $p_columns_target: see COLUMNS_TARGET_* in constant_inc.php, adicionado o $handler_view, para o relatório parcial, não será mostrado para queme stá atribuído quando ele receber 1, PROSEGUR 08/06/2011
	...
	# --------------------
	# $p_columns_target: see COLUMNS_TARGET_* in constant_inc.php, inserido o parâmetro $view_private_icon para chamar personalizadamente sem exibir o ícone de caso privado no sumário do relatório parcial PROSEGUR 08/06/2011
