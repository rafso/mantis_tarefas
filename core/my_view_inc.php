...
//filtros personalizados em my view PROSEGUR 06/03/2011
$c_filter['doing'] = array(
		'show_status'		=> Array ( '0' => 50 )
		);
$url_link_parameters['doing'] = 'show_status=' . 50 . '&amp;hide_status=' . $t_hide_status_default;

//aguardando bugs PROSEGUR 06/03/2011
$c_filter['waitbugs'] = array(
		'show_status'		=> Array ( '0' => 90 ),
		);
$url_link_parameters['waitbugs'] = 'show_status=' . 90 . '&amp;hide_status=' . $t_hide_status_default;

//aguardando bugs PROSEGUR 06/03/2011
$c_filter['stoped'] = array(
		'show_status'		=> Array ( '0' => 70 )
		);
$url_link_parameters['stoped'] = 'show_status=' . 70 . '&amp;hide_status=' . $t_hide_status_default;

//prazo terminando PROSEGUR 06/03/2011
$c_filter['timeend'] = array(
		'show_category'		=> Array ( '0' => META_FILTER_ANY ),
		'show_severity'		=> Array ( '0' => META_FILTER_ANY ),
		'show_status'		=> Array ( '0' => META_FILTER_ANY ),
		'highlight_changed'	=> $t_default_show_changed,
...
$url_link_parameters['timeend'] = 'hide_status=none';
...
<?php //adicionando cabeçlho no my view PROSEGUR 06/03/2011
echo	"<tr><b>
		<td>"
		. lang_get('num') .
		"</td>
...
<tr bgcolor="<?php echo $status_color ?>">
	...
	<td class="center" valign="top" width ="8%" nowrap>
		<span class="small">
		<?php
			print_bug_link( $v_id );
	...
	<td class="left" valign="top" width='50%'>
	 ...
	 <?php //adicionado para exibir para quem está associado uma tarefa na lista de my views PROSEGUR 06/03/2011
	if ($v_handler_id > 0){
		echo "<td width='27%'>";
		echo user_get_name($v_handler_id); 
		echo "</td>";
	} else echo "<td></td>";
		//insere a data de entrega das tarefas
		$tstamp = new DateTime($v_date_end);
